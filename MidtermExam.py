# Considering the receipt is divided into three main parts, we will then have to create 3 classes:
# Create a class for getting service information.
class ServiceInformation:
    ...
    # Assigns the input into its defined self.
...
# Create a class for getting metering information.
...
# Create a class for getting billing summary.

...
class Assessment_Amount:
    ...
    def get_student_assesssment(self, adu_chronical, athletic, audio_visual_library,
        ...
        self.other_assessment = (adu_chronical + athletic + audio_visual_library + ausg + cultural_fee + energy_cost
                                 + guidance + insurance_fee + learning_management_system + library_fee + medical_dental + registration + rso
                                 + student_activities + student_nurturance + technology_fee + test_papers + other_assessment)

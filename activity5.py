class Student_Info:
    ...
    def display_student_data(self):
        ...
        print(
            f"| COURSE : {self.student_course:<{course_width}} | ACAD. YEAR  : {self.academic_year:<{year_width}}\t |")
        print("-" * width)
...
class Assessment_Amount:
    ...
    def get_student_assesssment(self, adu_chronical, athletic, audio_visual_library,
        ...
        self.other_assessment = (
                    self.tuition_fee_lecture_total + adu_chronical + athletic + audio_visual_library + ausg + cultural_fee
